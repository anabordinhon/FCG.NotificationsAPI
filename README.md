...
Confirmação de Compra (Purchase Confirmation):
...
Via Docker Compose
Na raiz do projeto orquestrador, execute o comando para subir o serviço: docker-compose up -d fcg-notifications-processor

Via Kubernetes (Deploy Automatizado)
Utilize o script PowerShell na raiz do repositório: .\orchestrator.ps1
